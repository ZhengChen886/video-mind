...
import { openSettingsModal, loadConfigFromServer, loadProviderConfig, loadModelSelectModels, renderModelsTable, switchProviderTab, getCurrentEditingProviderId, addModelRow, removeModelRow, fetchModels, saveModelsToProvider, saveModelsFromTable, saveSettings } from './settings.js';
    ...
    if (targetPage) {
        ...
        if (pageName === 'home') {
            ...
            if (window.KnowledgeApp) {
                ...
                if (typeof window.KnowledgeApp.loadModels === 'function') {
                    window.KnowledgeApp.loadModels();
                }
            }
        }
    }
